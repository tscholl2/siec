...
func Test_normalize(t *testing.T) {
	...
	tests := []struct {
		...
		{"p", pFF, Element{0, 0, 0, 0}},
		{"(p-1)/2", Element{563089565290528, 4611686018427387904, 16779296, 2305843009213693952}, Element{563089565290528, 4611686018427387904, 16779296, 2305843009213693952}},
		{"(p+1)/2", Element{563089565290529, 4611686018427387904, 16779296, 2305843009213693952}, Element{563089565290528, 4611686018427387904, 16779296, 11529215046068469760}},
	}
